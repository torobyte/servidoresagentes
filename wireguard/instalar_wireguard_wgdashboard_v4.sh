#!/usr/bin/env bash
# Instalador desatendido WireGuard + WGDashboard para Ubuntu 20.04/22.04/24.04
# Adaptado y reforzado a partir de la idea de:
# https://github.com/devrimerduman/WireGuard-and-WGDashboard-Installer
# Usa el método oficial actual de WGDashboard v4.3.3, instala Python 3.12 cuando
# sea necesario e incluye interfaz wg0, NAT, UFW, systemd y diagnóstico final.
#
# Uso:
...
PY
    ...
    printf '\n' | PATH="$(dirname "$PYTHON_BIN"):${PATH}" ./wgd.sh install
...
main() {
    echo "============================================================================"
    echo " INSTALADOR WIREGUARD + WGDASHBOARD - UBUNTU 20.04/22.04/24.04"
